...
skill at `../gallery/job-application-portal.md`. **New session.**
...
**footnote** provenance. Save the result as `../gallery/job-application-storyline.md`.
...
Save as `../gallery/job-application-brief.md`.
...
table. Save as `../gallery/job-application-handoff.md`.

### 2d — Interactive HTML (for a workshop: let them *explore*)
```
Create an interactive HTML version my design team can use as a workshop reference. Save it to site/renderings/job-application--cardgrid.html.
```
